/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 51c373fe6abe0fc22f306420b1fd7a81)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WAITLIST_NOTIFICATION_EMAIL: SendEmail;
		ASSETS: Fetcher;
		WAITLIST_NOTIFICATION_TO: "owner@example.com";
		WAITLIST_NOTIFICATION_FROM: "noreply@example.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WAITLIST_NOTIFICATION_TO" | "WAITLIST_NOTIFICATION_FROM" | "WAITLIST_NOTIFICATION_SENDER_NAME">> {}
}
